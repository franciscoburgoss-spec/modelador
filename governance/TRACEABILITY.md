...
| REQ-DOM-002 | R4–R8 completan catálogo, roles, encuentros, checks e informe | R-005 | legado D-016–033 + gobernanza D-018–029 | SPEC-R4 + SPEC-R5 + SPEC-R6 + SPEC-R7 + SPEC-R8 | cierres `SPEC-R4-A/B/C`, `SPEC-R5-A/B/C`, `SPEC-R6-A/B/C`, `SPEC-R7-A/B/C`, `SPEC-R8-A`; `r8ReportMarkdown.test.mjs` 8/8; R8-B/C y pruebas UI/DXF pendientes | G4 | En curso |
