...
| REQ-DOM-002 | R4–R8 completan catálogo, roles, encuentros y checks | R-005 | legado D-016–033 + D-018 | SPEC-R4 + ROADMAP-R1-R8 | spec R4 gobernada + `close-SPEC-R4-A` + cierres R4–R8 | G4 | En curso |
