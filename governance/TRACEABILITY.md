...
| REQ-DOM-002 | R4–R8 completan catálogo, roles, encuentros y checks | R-005 | legado D-016–033 + gobernanza D-018–020 | SPEC-R4 + SPEC-R5 + ROADMAP-R1-R8 | cierres `SPEC-R4-A/B/C`, `SPEC-R5-A` + cierres R5-B/C y R6–R8 | G4 | En curso |
