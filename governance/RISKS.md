...
| R-005 | Reglas constructivas incompletas producen planos incorrectos | 4 | 4 | 16 | R3–R7-B cerrados; checks de muro/techumbre tienen cobertura y `MIN_TRAMO` visible; R7-C y R8 deben cerrar G4 | Abierto |
