...
| R-005 | Reglas constructivas incompletas producen planos incorrectos | 4 | 4 | 16 | R3–R8 cerrados; R8-C prueba cuatro variantes A3 con DXF 0/0. `SPEC-003` debe fijar fixtures y auditoría global reproducible para cerrar G4 | Abierto |
