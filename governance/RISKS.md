...
| R-004 | Corrupción por guardado interrumpido | 3 | 5 | 15 | A fija temporal+fsync+rename, diez backups y kill; B agrega commit transaccional y protege ediciones durante save; falta adoptar el contrato en Tauri y cubrir recovery; G6 | En mitigación |
...
| R-008 | Permisos Tauri demasiado amplios | 3 | 5 | 15 | C implementa seis comandos autorizados, capability `main` y CSP local sin shell/fs/HTTP/opener; falta smoke C1 y recovery; G6 | En mitigación |
| R-009 | Dependencia de macOS fuera de soporte | 5 | 4 | 20 | C reprodujo panic de Tauri 2.11 y C1 también con Wry 0.48; C1 fija Wry 0.44 previo a `objc2` y exige smoke macOS 11 a cada actualización; renovar hardware para eliminar | Aceptado |
