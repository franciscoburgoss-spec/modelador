...
| R-007 | INP sintácticamente válido pero estructuralmente inválido | 3 | 5 | 15 | C0 eliminó los 16 `NaN`; C-DIAG confirmó 125 referencias `ELSET` largas, cuatro fundaciones globales sin sección y que CCX puede informar `Job finished`/código 0 junto a `*ERROR`; C1 exige parser, inspección de salida y tres jobs antes de G5 | Abierto |
