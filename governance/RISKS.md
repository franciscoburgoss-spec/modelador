...
| R-005 | Reglas constructivas incompletas producen planos incorrectos | 4 | 4 | 16 | R3–R7 y R8-A/B cerrados; pantalla e informe comparten snapshot/margen y descarga trazable; R8-C debe integrar criterios DXF y auditoría 0/0 para cerrar G4 | Abierto |
...
| R-011 | Herramientas no reproducibles entre sesiones | 4 | 4 | 16 | Node/Rust/Python fijados y doctor; registrador acepta `SPEC-Rn`; gobernanza aún debe recorrer `specs/domain/`; G0/G1 | Abierto |
