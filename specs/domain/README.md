...
`sessions/close-SPEC-R6-*.md`. `SPEC-R7-checks.md` está activa en tres cortes: A para checks de
muro, B para techumbre/`MIN_TRAMO` y C para capacidad por dirección. R8 se redactará desde
